...
class TestSedRule:
    ...
    def test_sed_rule_with_flags(self):
        ...
        rule = SedRule(pattern="test", replacement="TEST", flags=re.IGNORECASE, global_replace=True)
...
class TestApplySedTransforms:
    ...
    def test_global_replacement(self):
        ...
        rules = [SedRule(pattern="test", replacement="TEST", global_replace=True)]
    ...
    def test_non_global_replacement(self):
        ...
        rules = [SedRule(pattern="test", replacement="TEST", global_replace=False)]
        result = apply_sed_transforms("test test test", rules)
        assert result == "TEST test test"
    ...
    def test_case_insensitive_replacement(self):
        ...
        rules = [
            SedRule(pattern="EAST", replacement="WEST", flags=re.IGNORECASE, global_replace=True)
        ]
    ...
    def test_regex_pattern(self):
        ...
        rules = [SedRule(pattern=r"\d+\.\d+\.\d+\.\d+", replacement="0.0.0.0", global_replace=True)]
...
class TestJsonMapping:
    ...
    def test_valid_json_mapping(self):
        ...
        mapping = JsonMapping(path="$.database.host", find="db1.us-east-1", replace="db1.us-west-2")
    ...
    def test_invalid_jsonpath(self):
        ...
        with pytest.raises(TransformationError, match="Invalid JSONPath"):
            JsonMapping(path="$invalid[path", find="test", replace="value")
...
class TestApplyJsonTransforms:
    ...
    def test_simple_field_replacement(self):
        ...
        mappings = [
            JsonMapping(path="$.database.host", find="db1.us-east-1", replace="db1.us-west-2")
        ]
    ...
    def test_partial_string_replacement(self):
        ...
        mappings = [JsonMapping(path="$.url", find="us-east-1", replace="us-west-2")]
        result = apply_json_transforms(secret, mappings)
        import json
    ...
    def test_nested_field_replacement(self):
        ...
        mappings = [JsonMapping(path="$.level1.level2.level3", find="value", replace="new_value")]
        result = apply_json_transforms(secret, mappings)
        import json
    ...
    def test_nonexistent_path(self):
        ...
        secret = '{"field": "value"}'
        mappings = [JsonMapping(path="$.nonexistent.field", find="value", replace="new_value")]
    ...
    def test_no_match(self):
        ...
        secret = '{"field": "value"}'
        mappings = [JsonMapping(path="$.field", find="different_value", replace="new_value")]
        result = apply_json_transforms(secret, mappings)
        import json
...
line3: us-east-1"""
    ...
    def test_json_with_arrays(self):
        ...
        mappings = [JsonMapping(path="$.endpoints[*]", find="us-east-1", replace="us-west-2")]
        result = apply_json_transforms(secret, mappings)
        import json
...
class TestExpandVariables:
    ...
    def test_custom_variables_override(self):
        ...
        context = {"REGION": "us-east-1", "CUSTOM_VAR": "my-custom-value", "APP_NAME": "my-app"}
